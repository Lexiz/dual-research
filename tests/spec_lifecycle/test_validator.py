...
## 1. Context
We need to update `src/dual_research/ui/static/app.jsx:42` because it
duplicates logic from `src/dual_research/ui/static/shared.jsx:120`.
...
- [ ] Integration smoke on hosted UI
